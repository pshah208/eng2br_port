...
The access token must be issued by the configured Entra External ID tenant and have the correct audience (`ENTRA_CLIENT_ID`). The API validates it using JWKS (RS256).
